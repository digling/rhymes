...
def aline(line, warnings):
    ...
    return stripped_line, rhymewords, comment, warnings
    ...
    if line[0].isdigit():
        ...
        if ecount <= 1 and poem:
            ...
            for i, l in enumerate(lines):
                s, r, c, warnings = aline(l, warnings)
...
with open('Wang1980.tsv', 'w') as f:
    f.write('ID\tPOEM_NUMBER\tPOEM_NAME\tSTANZA\tLINE_IN_SOURCE\tLINE\tRHYME\tRHYMEWORD\tRECONSTRUCTION\tCOMMENT\n')
    for k in sorted(D):
